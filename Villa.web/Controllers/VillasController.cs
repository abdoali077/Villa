...
namespace Villla.Web.Controllers
{
    ...
    public class VillasController : Controller
    {
        ...
        {
            await _villaService.CreateAsync(dto);
            TempData["Success"] = "Villa created successfully.";
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(VillaDto dto)
        {
            await _villaService.UpdateAsync(dto);
            TempData["Success"] = "Villa updated successfully.";
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            await _villaService.DeleteAsync(id);
            TempData["Success"] = "Villa deleted successfully.";
            return RedirectToAction(nameof(Index));
        }
